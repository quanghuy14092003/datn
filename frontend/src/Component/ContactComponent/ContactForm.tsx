                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="box-contact-right">
                                ...
                                <p className="font-md mb-40">Nếu bạn cần hỗ trợ về thẻ Lyx Fury hiện có, vui lòng gửi email tới: lienhe@LyxFury.vn Để nói chuyện với ai đó trong nhóm bán hàng của chúng tôi, vui lòng nói chuyện với chuyên gia</p>
